...
END_SERIAL LD	IX,MPF_I  	;IX points to '-Err  '
...
BIT1_5_DELAY: LD B,4DH      ; old value 20H with 330pF
...
USERPC	.BLOCK	2
;
ADSAVE	.BLOCK	2		;Contains the address being
				;displayed now.
...
TEST	.BLOCK	1		;Flag, bit 0 -- set when function
...
IM1AD	.BLOCK	2		;Contains the address of Opcode 'FF'
